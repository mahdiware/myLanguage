...
enum {
  /*00*/  TK_NAME,   // Token for a name
           TK_NMBR,   // Token for a number
           TK_STRL,   // Token for a string literal
           TK_WSPC,   // Token for whitespace
           TK_LCOM,   // Token for a line comment
  /*05*/  TK_BCOM,   // Token for a block comment
           TK_TRUE,	  // Token for boolean true
           TK_FALSE,	// Token for boolean false
           TK_NULL,		// Token for string null
           TK_LPAR,   // Token for a left parenthesis '('
  /*10*/  TK_RPAR,   // Token for a right parenthesis ')'
  ...
  /*15*/  TK_FUNC,	// Token for the 'function' keyword
  ...
  /*20*/  TK_WHIL,   // Token for the 'while' keyword
  ...
  /*25*/  TK_GTHN,   // Token for the greater than operator '>'
  ...
  /*30*/  TK_PLUS,   // Token for the plus operator '+'
  ...
  /*35*/  TK_NEGA,   // Token for the logical negation operator '!'
...
int lexer(const uint8_t *, size_t, struct token **, size_t *);
